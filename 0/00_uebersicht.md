# Python Fortgeschritten - Kursübersicht

## Willkommen zum Python Fortgeschritten Seminar

Dieser Kurs richtet sich an Teilnehmer, die bereits solide Grundkenntnisse in Python haben und nun tiefer in fortgeschrittene Konzepte und Best Practices einsteigen möchten. Wir behandeln:
...
- **itertools**: Mächtige Werkzeuge für Iterator-Operationen
- **Sortierung**: Komplexe Sortierungen mit key-Funktionen
- **Rekursion**: Rekursive Problemlösungen und deren Grenzen
...
- **Exception Handling**: try/except Blöcke und Best Practices
- **Custom Exceptions**: Eigene Fehlerklassen für spezifische Anwendungsfälle
...
- **Magische Methoden**: Operator-Überladung und spezielle Verhaltensweisen
...
**Was du lernst**: Wie du Python in der Praxis einsetzt - von Datenanalyse über Performance-Optimierung bis hin zu GUI-Entwicklung.
...
✅ **Robuste Software** mit professioneller Fehlerbehandlung
✅ **Fortgeschrittene OOP-Konzepte** verstehen und anwenden  
✅ **Performance-Optimierung** durch Memoisation, Generatoren und `__slots__`  
✅ **Design Patterns** für wiederkehrende Probleme  
✅ **Wissenschaftliche Bibliotheken** NumPy, Pandas, Matplotlib, etc. 
✅ **Parallelisierung** mit Threads und Multiprocessing
✅ **Python-Packages** erstellen und verteilen  

## Voraussetzungen

- Solide Python-Grundkenntnisse (Variablen, Funktionen, Listen, Dictionaries, Schleifen)
- Grundverständnis von Klassen und Objekten
- Erfahrung mit Jupyter Notebooks (siehe `EinführungsNotebooks/jupyter_intro.ipynb`)
- Bereitschaft, Code-Beispiele selbst auszuführen und zu experimentieren

## Empfohlene Arbeitsweise

1. **Notebooks der Reihe nach durcharbeiten** - Jeder Tag baut auf dem vorherigen auf
2. **Code selbst ausführen** - Nur durch Ausprobieren versteht man die Konzepte
3. **Aufgaben selbst lösen** - Vor dem Blick auf die Musterlösungen
...
- **Einführungsnotebook**: `EinführungsNotebooks/jupyter_intro.ipynb`
